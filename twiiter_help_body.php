...
<div class="wrap" id="weblizar_wrap">
	<div id="content_wrap">
		<div class="weblizar-header">
			<h2><span class="dashicons dashicons-twitter"
					style="width: auto;"><?php esc_html_e('Customize Feeds for Twitter', 'twitter-tweets'); ?></span>
			</h2>
			<br>
			<div class="weblizar-submenu-links" id="weblizar-submenu-links">
				<ul>
					<li class="">
						...
						<a href="https://wordpress.org/plugins/twitter-tweets/" target="_blank"
							title="<?php esc_attr_e('Support Forum', 'twitter-tweets'); ?>">
							<?php esc_html_e('Support Forum', 'twitter-tweets'); ?></a>
					</li>
					<li class="">
						<div class="dashicons dashicons-welcome-write-blog"></div>
						<a href="<?php echo esc_url(WEBLIZAR_TWITTER_PLUGIN_URL . 'readme.txt'); ?>" target="_blank"
							title="<?php esc_attr_e('Plugin Changelog', 'twitter-tweets'); ?>">
			...
			<ul class="options_tabs ui-tabs-nav" role="tablist" id="nav">
				<li class="active">
					<a id="general">
						...
						<?php esc_html_e('Feeds Widget', 'twitter-tweets'); ?>
					</a>
				</li>
				<!-- <li>
					<a id="apikey">
				...
				<li>
					<a id="needhelp">
						...
						<?php esc_html_e('Need Help', 'twitter-tweets'); ?>
					</a>
				</li>
				<!-- <li>
					<a id="ourproduct">
